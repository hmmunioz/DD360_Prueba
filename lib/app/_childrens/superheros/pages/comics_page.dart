...
class ComicsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => bloc.Bloc()..add(bloc.GetComicsEvent(superheroModel)),
      child: _Content(superheroModel: superheroModel),
    );
  }
}
          ...
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<bloc.Bloc, bloc.State>(builder: (context, state) {
                List<Comic> comics =
                    (state.model.comicsList ?? []).toSet().toList();

                if (comics.isEmpty && state is bloc.LoadedComicsState) {
                  return Center(
                    child: NoResultWidget(
                      ...
                      onTap: () {
                        context
                            .read<bloc.Bloc>()
                            .add(bloc.GetMoreComicsEvent(superheroModel));
                      },
                    ),
                  );
                  ...
                  return SizedBox(
                    ...
                    child: RefreshIndicator(
                      onRefresh: () async {
                        context
                            .read<bloc.Bloc>()
                            .add(bloc.ReloadComicsEvent(superheroModel));
                      },
